...
const migrations = [
  "supabase/migrations/20260603120000_store_metal_prices.sql",
  "supabase/migrations/20260604120000_store_metal_prices_manual_creator.sql",
];
...
try {
  ...
  console.log("Migration OK — dev.store_metal_prices rows:", count.rows[0]?.n);
} catch (err) {
