...
const sql = readFileSync(
  "supabase/migrations/20260608120000_vridhhi_enquiries.sql",
  "utf8"
);
...
try {
  ...
  const count = await client.query(
    "select count(*)::int as n from dev.vridhhi_enquiries"
  );
  console.log("Migration OK — dev.vridhhi_enquiries rows:", count.rows[0]?.n);
